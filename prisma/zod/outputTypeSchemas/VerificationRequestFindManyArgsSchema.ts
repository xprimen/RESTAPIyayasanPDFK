...
export const VerificationRequestFindManyArgsSchema: z.ZodType<Prisma.VerificationRequestFindManyArgs> = z.object({
...
export default VerificationRequestFindManyArgsSchema;

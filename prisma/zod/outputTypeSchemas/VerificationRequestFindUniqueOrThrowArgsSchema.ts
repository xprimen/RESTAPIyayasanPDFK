...
export const VerificationRequestFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.VerificationRequestFindUniqueOrThrowArgs> = z.object({
  select: VerificationRequestSelectSchema.optional(),
  where: VerificationRequestWhereUniqueInputSchema,
}).strict() ;

export default VerificationRequestFindUniqueOrThrowArgsSchema;

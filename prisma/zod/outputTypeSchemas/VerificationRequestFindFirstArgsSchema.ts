...
export const VerificationRequestFindFirstArgsSchema: z.ZodType<Prisma.VerificationRequestFindFirstArgs> = z.object({
...
export default VerificationRequestFindFirstArgsSchema;

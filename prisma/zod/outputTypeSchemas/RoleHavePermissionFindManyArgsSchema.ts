...
export const RoleHavePermissionFindManyArgsSchema: z.ZodType<Prisma.RoleHavePermissionFindManyArgs> = z.object({
...
export default RoleHavePermissionFindManyArgsSchema;

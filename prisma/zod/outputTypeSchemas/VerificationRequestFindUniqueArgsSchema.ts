...
export const VerificationRequestFindUniqueArgsSchema: z.ZodType<Prisma.VerificationRequestFindUniqueArgs> = z.object({
  select: VerificationRequestSelectSchema.optional(),
  where: VerificationRequestWhereUniqueInputSchema,
}).strict() ;

export default VerificationRequestFindUniqueArgsSchema;

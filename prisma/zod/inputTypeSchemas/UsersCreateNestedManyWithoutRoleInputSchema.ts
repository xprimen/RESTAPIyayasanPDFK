...
export const UsersCreateNestedManyWithoutRoleInputSchema: z.ZodType<Prisma.UsersCreateNestedManyWithoutRoleInput> = z.object({
...
export default UsersCreateNestedManyWithoutRoleInputSchema;

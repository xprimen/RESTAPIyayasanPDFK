...
import { ProfilesUncheckedUpdateOneWithoutUserNestedInputSchema } from './ProfilesUncheckedUpdateOneWithoutUserNestedInputSchema';

export const UsersUncheckedUpdateWithoutRoleInputSchema: z.ZodType<Prisma.UsersUncheckedUpdateWithoutRoleInput> = z.object({
  ...
  profile: z.lazy(() => ProfilesUncheckedUpdateOneWithoutUserNestedInputSchema).optional()
}).strict();

export default UsersUncheckedUpdateWithoutRoleInputSchema;

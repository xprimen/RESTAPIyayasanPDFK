...
export const ProfilesCreateNestedOneWithoutUserInputSchema: z.ZodType<Prisma.ProfilesCreateNestedOneWithoutUserInput> = z.object({
...
export default ProfilesCreateNestedOneWithoutUserInputSchema;

...
export const UsersCreateWithoutProfileInputSchema: z.ZodType<Prisma.UsersCreateWithoutProfileInput> = z.object({
...
export default UsersCreateWithoutProfileInputSchema;
